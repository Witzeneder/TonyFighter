...
public class GameManagerEnemy : MonoBehaviour {
		...
		public GameOverMeEnemy gameOverMenu;
		...
		public PlayerCon player;						//starting point of the Platforms
		...
		private ScoreManagEnemy scoreManager;					//for the scoreCounter
		...
		scoreManager = FindObjectOfType<ScoreManagEnemy> ();
		}
